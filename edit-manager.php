...
if (isset($_SESSION['id']) && isset($_SESSION['user_name'])) {
  if (isset($_GET['id'])) {
    $sql = "SELECT * FROM manager WHERE manager_id='" . $_GET['id'] . "'";
    ...
    <body>
      ...
      <section class="home-section">
        ...
        <div class="home-content home-content-edit">
          <h4 style="text-align:center">Edit Manager </h4>
          <div class="overview-boxes">
            <div class="box">
              <div class="right-side">
                <form action="./controller/edit-man.php?id=<?php echo $_GET['id'] ?>" method="POST">
                  ...
                  <div class=" form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email" name="Email" value="<?php echo $row['email']; ?>">
                  </div>
                  <div class="form-group">
