    ...
    <body>
        ...
        <section class="home-section">
            ...
            <div class="home-content home-content-edit">
                <h4 style="text-align:center">Create Customer </h4>
                <div class="overview-boxes">
                    <div class="box">
                        <div class="right-side">
                            <form action="./controller/add-cus.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email" name="Address">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Phone 1</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Phone1" name="Phone1">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Phone 2</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Phone2" name="Phone2">
                                </div>
                                <input type="hidden" id="sellerId" name="sellerId" value="<?php echo $_SESSION['id']; ?>">
